...
type
  TfrmMainMenu = class(TfrmBaseMainMenu)
    TFCalDiagn: TdxTileControlItem;
    TFCodiciRadiologia: TdxTileControlItem;
    TFStruttura: TdxTileControlItem;
    TFUtenti: TdxTileControlItem;
    TFSetupGenerale: TdxTileControlItem;
    TFTabGenerale: TdxTileControlItem;
    rsAccessi: TrsStorage;
    rsXMLAccessi: TrsXMLData;
    rsPropAccessi: TrsPropSaver;
    HTMLHint1: THTMLHint;
    cxImageList1: TcxImageList;
    TFTabStampe: TdxTileControlItem;
    TFzRadCodDiagn: TdxTileControlItem;
